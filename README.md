...
You can choose whatever port you want, but the app will be based on 3000. Be aware that the frontend ru


# Frontend
The frontend is next.js-based.
We have NOT used React Compiler.
...
Then make sure you are in the right directory (based from the root of the project)
